...
export const ApproverForm: React.FunctionComponent<IPurchaseRequisitionsProps> = (props: IPurchaseRequisitionsProps) => {
    ...
    async function onRequestInitiate(formValues: any) {
       ...
       // await EmployeeOps().getEmployeeMasterId(props.currentSPContext.pageContext.legacyPageContext.userId, props).then(async (empResult) => {
            ...
            if (appMatrixResult.length <= 0) {
                ...
                await DOAMatrixOps().getDOAMatrix("Id,Title,AmountGreaterThan,AmountLessThan,Approver/Id,Approver/Title,Status,RequestType,Level/Level,Level/Id,Designation/Designation,Designation/Id", "Approver,Level,Designation", "RequestType eq '"+PurchaseRequisition.RequestType+"' and Level/Level eq 'Level 1'", { column: 'Id', isAscending: false }, props).then(async (appMatrixDetails) => {
                    //let PRRequest:any;
                     let PRRequest = {
                   
                   'ApproverStatus':'Pending'
                        //    ,'NextRoleId':appMatrixDetails.DesignationId
                        //    ,'NextApprovalLevelId':appMatrixDetails.LevelId
                        //    ,'NextApproversId':appMatrixDetails.ApproverId
                    };
